## OpenNMS TM Forum Rest SPM interface plugin

### Maven Project
~~~~
project groupId: org.opennms.plugins
project name:    opennms-tmforum-rest-spm-plugin
...
karaf@root> features:addurl mvn:org.opennms.plugins/opennms-tmforum-rest-spm-plugin/19.0.0-SNAPSHOT/xml/features
karaf@root> features:install opennms-tmforum-rest-spm-plugin

(or features:install opennms-tmforum-rest-spm-plugin/19.0.0-SNAPSHOT for a specific version of the feature)
~~~~
