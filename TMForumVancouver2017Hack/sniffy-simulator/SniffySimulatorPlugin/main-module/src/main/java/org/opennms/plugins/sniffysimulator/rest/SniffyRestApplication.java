...
public class SniffyRestApplication extends Application {
	private static final Logger LOG = LoggerFactory.getLogger(SniffyRestApplication.class);
	
	public SniffyRestApplication(){
		super();
		LOG.info("Sniffy ReST Service starting");
	}
	...
	public void destroyMethod(){
		LOG.info("Sniffy ReST Service shutting down");
	}
